...
namespace RPGI.World
{
    public class MonsterFactory
    {
		public Monster createMonster(Monsters type)
		{
			...
			if (type == null)
			{
				throw new ArgumentException("Monster type was null");
			}
			...
			switch (type)
			{
				...
				default:
					throw new ArgumentException("Monster type is not implemented");
